...
public class Functions {
    ...
    public static final IFunction F1 = point -> {
    ...
    public static final IFunction F3 = point -> {
        double res = 0;
    ...
    public static final IFunction F6 = point -> {
        double sum = 0;
        for (Double x : point) {
            sum += x * x;
        }
    ...
    public static final IFunction F7 = point -> {
        double sum = 0;
        for (Double x : point) {
            sum += x * x;
        }
